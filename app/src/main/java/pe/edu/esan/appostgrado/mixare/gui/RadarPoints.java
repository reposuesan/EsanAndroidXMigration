...
public class RadarPoints implements ScreenObj {
	...
	/** Color */
	static int radarColor = Color.argb(100, 200, 0, 200);
	
	public static void setRadarColor(int radarColor) {
		RadarPoints.radarColor = radarColor;
	}
	...
	public void paint(PaintScreen dw) {
		...
		for (int i = 0; i < jLayer.getMarkerCount(); i++) {
			...
			if (pm.isActive() && (x * x + y * y < RADIUS * RADIUS)) {
				...
				dw.setColor(Color.parseColor(pm.getColor()));
