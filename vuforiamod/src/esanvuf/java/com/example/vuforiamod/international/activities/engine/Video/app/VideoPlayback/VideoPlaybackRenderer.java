...
import com.vuforia.*;
import com.example.vuforiamod.international.activities.engine.SampleApplication.SampleAppRenderer;
import com.example.vuforiamod.international.activities.engine.SampleApplication.SampleAppRendererControl;
import com.example.vuforiamod.international.activities.engine.SampleApplication.SampleApplicationSession;
import com.example.vuforiamod.international.activities.engine.SampleApplication.utils.SampleMath;
import com.example.vuforiamod.international.activities.engine.SampleApplication.utils.SampleUtils;
...
import com.example.vuforiamod.international.activities.engine.Video.app.VideoPlayback.VideoPlayerHelper.MEDIA_TYPE;
...
public class VideoPlaybackRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    ...
    private final MEDIA_TYPE[] mCanRequestType;
    ...
    private final MEDIA_STATE[] currentStatus = new MEDIA_STATE[VideoPlayback.NUM_TARGETS];
    ...
    VideoPlaybackRenderer(VideoPlayback activity, SampleApplicationSession session)
    {
        ...
        mSampleAppRenderer = new SampleAppRenderer(this, mActivityRef.get(),
                Device.MODE.MODE_AR, session.getVideoMode(),false,
                0.01f, 5f);
    ...
    public void renderFrame(State state, float[] projectionMatrix)
    {
        ...
        for (TrackableResult trackableResult : trackableResultList)
        {
            ...
            // calculation
            //if (imageTarget.getName().compareTo("vegas_vuforia_px") == 0)
            if (imageTarget.getName().compareTo("Semana2019-1") == 0)
